    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='data', serialize=False, to='users.employee')),
        ...
        migrations.AddIndex(
            model_name='employee',
            index=models.Index(fields=['first_name', 'last_name'], name='users_emplo_first_n_409610_idx'),
        ),
    ]
